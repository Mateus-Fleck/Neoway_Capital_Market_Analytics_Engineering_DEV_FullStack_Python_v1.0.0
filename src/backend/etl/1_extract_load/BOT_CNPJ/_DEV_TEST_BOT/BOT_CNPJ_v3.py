...
try:
    with open(arquivo_input_novo, mode='r', encoding='utf-8', newline='') as csv_file, \
         open(arquivo_output_completo, mode='w', encoding='utf-8', newline='') as output_file:
        ...
        for i, row in enumerate(csv_reader, start=1):
            if row:  # Verifica se a linha não está vazia
                ...
                csv_writer.writerow([nome_empresa, cnpj if cnpj else "", "Encontrado" if encontrado else "Não Encontrado"])
