...
def buscar_cnpj_google(nome_empresa):
    try:
        ...
        url = f'https://www.google.com/search?q={query}&num=1&hl=pt'
        ...
        if response.status_code == 200:
            ...
            time.sleep(60)  # Aguarda 1 minuto (60 segundos) antes de tentar novamente
...
arquivo_output = f"Output_{data_atual}_Busca_CNPJ_v1.csv"
    ...
    with open(arquivo_input_novo, mode='r', encoding='utf-8', newline='') as csv_file:
        ...
        with ThreadPoolExecutor() as executor:
            for i, row in enumerate(csv_reader, start=1):
                ...
                # Verifica se o arquivo de saída foi atualizado e imprime na tela
                if os.path.exists(arquivo_output_completo):
                    print(f'Arquivo de saída atualizado: {arquivo_output_completo}')

    # Salva os resultados finais
    salvar_resultados_parciais(resultados, arquivo_output_completo)

    print(f'Arquivo de saída final salvo em: {arquivo_output_completo}')
